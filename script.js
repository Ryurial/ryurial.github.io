...
function loadPlaces(position) {
    const params = {
        ...
        clientId: 'UZFY24HTSCYMGNJALD1IN4SNWP0NJ4RM42324S30P1MIJU2D',
        clientSecret: '2XAVIYVN55VUDZU3FNWZQMG2MGRZVXTIBPS3HLWNI4D4WCWC',
            ...
            .then((places) => {
                places.forEach((place) => {
                    ...
                    const clickListener = function (ev) {
                        ...
                        if (el && el === ev.target) {
                            alert("Clicked!--".ev.target.getAttribute('title'));
